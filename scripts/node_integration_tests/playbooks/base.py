...
class NodeTestPlaybook:
    ...
    def step_configure_requestor(self):
        ...
        assert requestor_config is not None
    ...
    def start_nodes(self):
        ...
        if provider_config is not None:
            print("Provider data directory: %s" % provider_config.datadir)
        ...
        if requestor_config is not None:
            print("Requestor data directory: %s" % requestor_config.datadir)
